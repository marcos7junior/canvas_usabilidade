          ...
          <div class="col-4 d-flex justify-content-end align-items-center">
            ...
            <div>
              <form action="login.php">
                <input class="botao_cadastro" type="submit" class="btn btn-sm btn-outline-secondary" value="Sign in">
              </form>
              <form action="cadastro.php">
                <input class="botao_cadastro" type="submit" class="btn btn-sm btn-outline-secondary" value="Sign up">
              </form>
            </div>
          </div>
        </div>
